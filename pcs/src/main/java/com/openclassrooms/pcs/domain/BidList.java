...
public class BidList {
	...
	public @NotNull(message = "Bid quantity is mandatory") Double getBidQuantity()
	{
		return bidQuantity;
	}

	public void setBidQuantity(@NotNull(message = "Bid quantity is mandatory") Double bidQuantity)
	{
